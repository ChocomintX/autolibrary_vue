    ...
    <el-main>
      <el-form label-position="left" label-width="80px" :model="formLabelAlign">
        ...
        <el-form-item label="座位号">
          <el-input v-model="formLabelAlign.seatID" placeholder="输入地图上显示的数字即可"></el-input>
        </el-form-item>
        <el-form-item label-width="0">
          <el-button @click="search" style="width: 100%">查询</el-button>
        </el-form-item>
      </el-form>

      <el-progress :text-inside="true" :stroke-width="24" :percentage="process"  :status="status"></el-progress>
